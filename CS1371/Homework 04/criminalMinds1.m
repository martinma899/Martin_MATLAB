...
function [bool] = logicmp(vec1,vec2)
    ...
    % This function basically does the exact same thing as isequal. It
    % takes whatever vectors and format them into strings, and then uses
    % strcmp.

    bool = strcmp(num2str(vec1),num2str(vec2));
